...
const required = [
  ...
  ['presenter evidence shortcut', '근거부터 설명'],
  ...
  ['panel customer copy confirmation', '고객용 카드 링크를 복사했습니다'],
  ['panel customer link boundary', '발표자 모드 없이 이 카드에서 열립니다'],
  ...
  ['product sales-safe next action', '제품 안내를 이어서 보기:'],
  ['product display-information next step', '표시사항 확인 순서'],

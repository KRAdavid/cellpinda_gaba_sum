...
const sourceReady = sourceRows.filter(line => !line.includes('| OPEN |')).length;
...
console.log(`- 과학 출처 검토: ${sourceReady}/${sourceRows.length}`);
...
if (!sourceReady) console.log('- 다음 조치: docs/GABA_SOURCE_REGISTER.md에 과학 출처를 등록하고 검토');

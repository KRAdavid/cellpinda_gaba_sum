...
try {
  ...
  assert('presenter operations board keeps human gates, next actions, and discussion queue visible', opsBoard.text.includes('핵심 역할 배정') && opsBoard.text.includes('다음 행동') && opsBoard.workstreams === 4 && opsBoard.links === 2 && opsBoard.hold === 4 && opsBoard.assignment && opsBoard.roles === 7 && opsBoard.assignmentButton && opsBoard.fieldSession && opsBoard.discussion && opsBoard.discussionItems === 4, JSON.stringify(opsBoard));

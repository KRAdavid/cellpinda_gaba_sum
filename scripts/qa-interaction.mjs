...
try {
  ...
  assert('consumer video summaries use a one-at-a-time review flow', videoShowcase.section && videoShowcase.title.includes('원문으로 확인') && videoShowcase.items === 7 && videoShowcase.summaries === 1 && videoShowcase.links.length === 0 && videoShowcase.actionButtons === 2 && videoShowcase.preview === 1 && videoShowcase.previewImageLoaded && videoShowcase.mediaButtons === 1 && videoShowcase.playIcon && videoShowcase.candidateNotes === 1 && videoShowcase.body.includes('오늘의 검토 흐름') && videoShowcase.body.includes('무엇을 어떻게 소개했나') && videoShowcase.body.includes('인물 소개') && videoShowcase.body.includes('권위 확인') && videoShowcase.body.includes('근거') && videoShowcase.body.includes('요약 근거') && videoShowcase.body.includes('사용') && videoShowcase.body.includes('오늘 공유된 검토 후보') && videoShowcase.body.includes('사람 감리 전 검토 후보') && videoShowcase.body.includes('권위·근거·권리 확인 전에는 일반 GABA 근거 자료로 사용하지 않습니다') && videoShowcase.body.includes('원문 링크는 상세 패널에서 선택') && videoShowcase.body.includes('이 영상 링크 공유') && videoShowcase.body.includes('영상 정보와 확인 기준 보기') && videoShowcase.body.includes('원문 확인 전') && !videoShowcase.body.includes('검토 보류') && !videoShowcase.body.includes('제한 사용') && !videoShowcase.body.includes('권위 영상 DB') && !videoShowcase.body.includes('수면제') && !videoShowcase.body.includes('영양제') && !videoShowcase.body.includes('보충제'), JSON.stringify(videoShowcase));

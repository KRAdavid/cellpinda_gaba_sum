...
try {
  ...
  assert('intro makes the full story the primary entry', introHierarchy.primary && introHierarchy.secondary && introHierarchy.primaryBackground !== 'rgba(0, 0, 0, 0)' && introHierarchy.label.includes('사업자·제품 문의'), JSON.stringify(introHierarchy));

...
try {
  ...
  assert('research opens in an in-page panel', researchPanel.title.includes('일반 GABA 연구') && researchPanel.source.includes('PMID 33041752') && researchPanel.verification.includes('연구를 읽는 기준') && researchPanel.verification.includes('대상·섭취량·기간·비교 조건') && !researchPanel.verification.includes('AI 사전 확인') && !researchPanel.verification.includes('SCIENCE·MEDICAL') && researchPanel.evidence.includes('스트레스 관련 근거는 제한적') && researchPanel.evidence.includes('수면 관련 근거는 매우 제한적') && researchPanel.external.includes('pubmed.ncbi.nlm.nih.gov') && !researchPanel.url.includes('pubmed'), JSON.stringify(researchPanel));

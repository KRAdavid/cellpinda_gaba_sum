...
try {
  ...
  assert('consumer video summaries live in a separate showcase section', videoShowcase.section && videoShowcase.title.includes('원문으로 확인') && videoShowcase.items === 7 && videoShowcase.summaries === 7 && videoShowcase.links.length === 0 && videoShowcase.actionButtons === 7 && videoShowcase.preview === 7 && videoShowcase.previewImageLoaded && videoShowcase.mediaButtons === 7 && videoShowcase.body.includes('무엇을 어떻게 소개했나') && videoShowcase.body.includes('인물 소개') && videoShowcase.body.includes('오늘 공유된 검토 후보') && videoShowcase.body.includes('원문 링크는 상세 패널에서 선택') && !videoShowcase.body.includes('권위 영상 DB'), JSON.stringify(videoShowcase));

...
assert('workflow runs daily and includes report archive changes', /cron:\s*'\d+\s+\d+\s+\*\s+\*\s+\*'/.test(workflow) && workflow.includes('docs/gaba-video-daily') && workflow.includes('concurrency:'));

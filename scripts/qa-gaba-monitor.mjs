...
assert('YouTube caption checks use browser-compatible fetching and readable empty-body warnings', monitor.includes('YOUTUBE_BROWSER_USER_AGENT') && monitor.includes('userAgent: YOUTUBE_BROWSER_USER_AGENT') && monitor.includes('자막 본문 응답 비어 있음'));

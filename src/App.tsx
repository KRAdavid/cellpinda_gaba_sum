...
function makeSlides(): Slide[] {
  return [
    {
      id: 'hook',
      label: '01 · 예민해지고 실수가 이어지는 날',
      title: '평소엔 넘길 일에 화가 먼저 나고, 작은 실수가 이어지는 날이 있죠.',
      body: '그럴수록 성분이나 제품보다 먼저, 내 상태와 휴식 시간을 돌아보는 것부터 시작해 보세요.',
      tone: 'deep',
    },
    {
      id: 'clear',
      label: '02 · 머리가 맑은 날',
      title: '잘 쉬고 난 뒤에는, 같은 일도 한 번 더 생각할 여유가 생깁니다.',
      body: '몸이 가벼운지뿐 아니라 생각이 정리되는지도 나의 생활 상태를 살피는 기준이 될 수 있습니다.',
      tone: 'fresh',
    },
    {
      id: 'overload',
      label: '03 · 생각이 멈추지 않는 날',
      title: '쉬는 중에도 생각이 멈추지 않고, 작은 일에 쉽게 반응한다면?',
      body: '수면·스트레스·생활 리듬 등 여러 요인이 있을 수 있습니다. 한 가지 성분이나 제품의 효과로 단정하지 마세요.',
      tone: 'warm',
    },
    {
      id: 'active-rest',
      label: '04 · 적극적인 휴식',
      title: '먼저 5분, 화면을 내려놓고 머리를 쉬게 해보세요.',
      body: '물을 마시거나 창밖을 바라보는 것처럼 지금 바로 할 수 있는 행동부터 시작합니다.',
      tone: 'green',
    },
    {
      id: 'gaba',
      label: '05 · 성분 일반정보',
      title: '이런 날 알아두면 좋은 성분 중 하나가 GABA입니다.',
      body: 'GABA는 우리 몸에 원래 있는 성분으로, 몸속 신호 전달에 관여한다고 알려져 있습니다. 이제 일반정보와 연구 조건을 차례로 살펴보겠습니다.',
      tone: 'green-dark',
    },
    {
      id: 'research',

...
export default function App() {
  ...
  const copyDailyMonitorBrief = async () => {
    ...
    const lines = [
      ...
      `권위 후보 게시 채널 사전 확인: ${snapshot.authorityPrecheckUrl}`,

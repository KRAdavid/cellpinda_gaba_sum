...
| OPS-01 | 매일 유사 후보 운영 | 09:17 KST 예약 설정·수동 감리 fallback·PENDING_REVIEW 유지 | GitHub Actions·일일 리포트·예약 실행 상태 배지 | AI-OPS + VIDEO | 실제 `schedule` 실행 확인과 사람 감리 3일 연속 기록 | HOLD |

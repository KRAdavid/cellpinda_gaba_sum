...
> 자동 생성일: 2026-09-24 13:52:13 KST · 실행 출처: GitHub Actions 예약 실행 · 기준일 2026-09-24 · 이 문서는 공개 승인 기록이 아니라 팀 검토 입력이다.
...
- 자막 상세 감사: [영상별 기록](gaba-video-daily/GABA_VIDEO_CAPTION_AUDIT_2026-09-24.md) · 트랙·본문 상태를 영상별로 보관

...
| 시나리오 | 시작점 | 확인할 것 |
| --- | --- | --- |
| A. 처음 보는 사람 | `card=1` | 01→09에서 GABA의 이름·기능·연구 한계를 이해하는가 |
| B. 권위 영상 질문 | `card=8` 또는 영상 DB | 승인 영상과 검토 후보를 구분하는가 |

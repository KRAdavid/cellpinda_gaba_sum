...
| 앱 최신 커밋 | `ebf2a31` |
| 릴리스 검증 기준 Pages 배포 | [run 35602189273](https://github.com/KRAdavid/cellpinda_gaba_sum/actions/runs/35602189273) (발표 모드 `처음부터` 복귀 보완본, 정적 번들 QA 및 공개 URL 320·390·1440px 매트릭스 통과) |

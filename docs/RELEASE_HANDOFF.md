...
| 앱 최신 커밋 | `a1c33fc` |
| 릴리스 검증 기준 Pages 배포 | [run 35591345277](https://github.com/KRAdavid/cellpinda_gaba_sum/actions/runs/35591345277) (정적 번들 QA 포함) |
...
| 상호작용 QA | 발표 딥링크·발표자 메모·키보드·Escape·연구 패널·제품 패널·다음 카드 전환·영업 시작점 01/07·카드 링크 공유 | 공개 URL 대상 `QA_URL=https://kradavid.github.io/cellpinda_gaba_sum/ pnpm run qa:interaction` 전체 통과 |

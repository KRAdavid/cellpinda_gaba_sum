...
| 앱 최신 커밋 | `5d7f595` |
| 릴리스 검증 기준 Pages 배포 | [run 35601314579](https://github.com/KRAdavid/cellpinda_gaba_sum/actions/runs/35601314579) (첫 3장 일상 카피 개선본, 정적 번들 QA 및 공개 URL 320·390·1440px 매트릭스 통과) |

...
| 최신 앱 공개 자산 직접 확인 | `index-kmkHFONx.js` HTTP 200, `7fcd458`의 발표 모드 `제품부터 설명`·인페이지 CTA sticky 고정·`다음 카드: 07 · 셀핀다 제품 정보`·`고객용 링크 복사`·접근성 라벨·연구 경계 문구 확인, 공개 URL 320·390·1440px 매트릭스 통과 |

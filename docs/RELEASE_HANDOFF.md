...
| 앱 최신 커밋 | `787cb00` |
| 최신 확인 Pages 배포 | [run 35590531100](https://github.com/KRAdavid/cellpinda_gaba_sum/actions/runs/35590531100) (`4badca7` 기준) |
...
| 상호작용 QA | 발표 딥링크·발표자 메모·키보드·Escape·연구 패널·제품 패널·다음 카드 전환·영업 시작점 01/07 | `pnpm run qa:interaction`, run `35590531100` |

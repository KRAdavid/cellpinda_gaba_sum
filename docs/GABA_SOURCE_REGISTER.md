...
2026-09-22 AI-OPS 사전 확인: PubMed 초록·NIH 공개 자료의 제목·저자·기관·핵심 범위와 한계를 대조했다. 아래 `AI_PRECHECKED`는 사람 과학·의료 검토를 끝냈다는 뜻이 아니며, 공개 문구의 최종 승인 상태는 `HUMAN_REVIEWED`로 별도 기록한다.
